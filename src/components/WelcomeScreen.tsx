    ...
    <div className="flex flex-col items-center justify-center flex-1 px-8">
      ...
      <div className="mb-8">
        <svg viewBox="0 0 120 120" className="w-32 h-32">
          ...
          <circle className="ring-segment" cx="60" cy="60" r="50" fill="none" stroke="var(--color-cat-folder)" strokeWidth="16"
            strokeDasharray="110 204" strokeDashoffset="0" transform="rotate(-90 60 60)" opacity="0.85" />
          <circle className="ring-segment" cx="60" cy="60" r="50" fill="none" stroke="var(--color-cat-media)" strokeWidth="16"
      ...
      <div className="stagger-in flex flex-col items-center">
        ...
        <div className="flex flex-col gap-3 w-72">
          ...
          <button
            ...
            className="btn-press flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-xl bg-[var(--color-bg-secondary)] text-[var(--color-text-primary)] font-medium text-sm border border-[var(--color-border)] hover:bg-[var(--color-bg-hover)] transition-all cursor-pointer"
          >
